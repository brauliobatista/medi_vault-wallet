...
export const getSurgeries = (userId: number) =>
...
export const getMedications = (userId: number) =>
...
export const getAllergies = (userId: number) =>
...
export const getFamilyHistory = (userId: number) =>
...
export const getAnalyticalExams = (userId: number) =>
...
export const getImagingExams = (userId: number) =>
...
export const getOptometryExams = (userId: number) =>
...
export const getVaccinations = (userId: number) =>
...
export const requestAccess = (userId: number) =>
...
export const getDoctorNotes = (userId: number) =>
...
export const getFlags = (userId: number) =>
